                                        ...
                                        <td className="py-3">
                                            <div className="flex items-center">
                                                <button
                                                    ...
                                                    className="p-2.25 flex items-center justify-center transition-colors bg-[#846adf]/20 hover:bg-[#846adf] duration-200 group"
                                                >
                                                    <Eye className="w-4 h-4 text-[#846adf] group-hover:text-white cursor-pointer" />
                                                </button>
                                                <button className="p-2 transition-colors border border-purple-500 hover:bg-[#846adf] hover:text-white hover:border-none cursor-pointer bg-white">

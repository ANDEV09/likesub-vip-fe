...
export default function UsersNotice() {
    ...
    return (
        <div
            className={`${isHidden ? "hidden" : "flex"} items-start justify-between w-full gap-2 bg-white shadow-md border-2 border-blue-200 rounded-sm p-4 h-28 ${isClosing ? "opacity-0 transition-colors duration-500 -translate-y-2" : "opacity-100 translate-y-0"}`}
        >
